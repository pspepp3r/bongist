...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2019 at 06:06 PM
...
(69, 1, NULL, NULL, 4, NULL, 'added a payment', 1563915195),
(70, 1, NULL, NULL, 4, NULL, 'added a payment', 1563915342),
(71, 1, NULL, NULL, 5, NULL, 'added a payment', 1563915515),
(72, 1, NULL, NULL, 6, NULL, 'added a payment', 1563915607),
(73, 1, NULL, NULL, 4, NULL, 'added a payment', 1563915619),
(74, 1, NULL, NULL, 4, NULL, 'added a payment', 1563915670),
(75, 1, NULL, NULL, 4, NULL, 'added a payment', 1563915675),
(76, 1, 'lugsn', NULL, NULL, NULL, 'added an order', 1564666629),
(77, 1, 'x1hq6', NULL, NULL, NULL, 'added an order', 1564668766),
(78, 1, 'zoj6t', NULL, NULL, NULL, 'added an order', 1564669093),
(79, 1, 'q6i74', NULL, NULL, NULL, 'added an order', 1564669472),
(80, 1, '77iwh', NULL, NULL, NULL, 'added an order', 1564672336),
(81, 1, '7kyvi', NULL, NULL, NULL, 'added an order', 1564672959),
(82, 0, NULL, NULL, NULL, 11, 'registered as a customer', 1565004230),
(83, 0, NULL, NULL, NULL, 12, 'registered as a customer', 1565004823),
(84, 0, NULL, NULL, NULL, 13, 'registered as a customer', 1565005068),
(85, 0, NULL, NULL, NULL, 14, 'registered as a customer', 1565005649);
...
(4, 'Ovie Tennyson', 'tennyson@codekago.com', 'ufa7th2dyv', 'avatar.png', '09067170010', '1866 Harrison Street', 0, 1563271457, 'jul', '2019'),
(10, 'Def Jam', 'lilkenzy02@yahoo.com', 'ufa7th2dyv', 'avatar.png', '08064496053', '1866 Harrison Street', 0, 1564672958, 'Aug', '2019'),
(14, 'Victor Davidson', 'victor@codekago.com', '$2y$09$3ZsS5V4uw4VlYo4wEz54KuPNtB64URs3/xF1PoMjZUMeXWdTahMS6', 'df9a2f0381db2b6e5c1f1ffa77bec3ca6ac32807.jpg', '4154747951', '1866 Harrison Street', 0, 1565005649, 'Aug', '2019');
...
INSERT INTO `orders` (`id`, `customer_id`, `cost`, `date_of_delivery`, `initial_deposit`, `status`, `order_id`, `staff_id`, `type_id`, `subcat_id`, `timestamp`, `month`, `year`, `balance`) VALUES
(11, 3, 600, '2019-07-04', 500, 1, 'pi21l', 1, 3, 6, 1562846788, 'feb', '2019', NULL),
(13, 4, 1200, '2019-07-26', 500, 1, 'e9rdo', 1, 2, 1, 1563271457, 'feb', '2019', 0),
(14, 4, 1000, '2019-07-18', 1000, 1, 'wg3nz', 1, 2, 3, 1563272673, 'mar', '2019', NULL),
(16, 4, 500, '2019-07-18', 500, 1, 'pd2wn', 1, 3, 5, 1563272884, 'jun', '2019', NULL),
(17, 4, 1300, '2019-07-20', 1200, 2, 'b37e1', 1, 2, 2, 1563273953, 'sep', '2019', NULL),
(23, 10, 1600, '2019-08-16', 1500, 1, '7kyvi', 1, 3, 6, 1564672959, 'Aug', '2019', 100);
...
(22, 'lugsn', 1, 'this is to test my verification', 1564666629),
(23, 'x1hq6', 1, 'this is a test of verification', 1564668766),
(24, 'zoj6t', 1, 'this is a test of verification', 1564669093),
(25, 'q6i74', 1, 'this is to test my validation', 1564669472),
(26, '77iwh', 1, 'this is a mail test', 1564672336),
(27, '7kyvi', 1, 'this is an email test', 1564672959);
...
(2, 3, 'pi21l', 2, 500, '', 1563189005, NULL),
(3, 4, 'b37e1', 2, 1200, '', 1563538681, NULL),
(4, 4, 'e9rdo', 1, 900, NULL, 1563915675, NULL),
(5, 4, 'e9rdo', 2, 200, NULL, 1563915515, 1),
(6, 4, 'e9rdo', 3, 100, NULL, 1563915607, 1);
...
INSERT INTO `staff` (`id`, `password`, `name`, `email`, `phone`, `address`, `photo`, `suspend`, `timestamp`, `role`, `password_reset`) VALUES
(1, '$2y$09$Nwz0HXUdO6zirCBmLbsrvulUFEyqldyZqMQoskskBb2ks8f7juSZe', 'admin', 'info@bongistkoncept.com', NULL, 'Shelter Afrique', 'avatar.png', 0, NULL, 1, ''),
(15, '$2y$09$8SXtIpJrlhtgaCop9bDcguZ63eriEyh8pt55GefOrrMvZBdBGjnCC', 'Kenneth Ekandem', 'lilkenzy02@gmail.com', '08081730456', 'Abak Road', '561c5b06e7d5bcbceedfb325344f4674612d6411.jpg', 0, 1562240971, 2, NULL);
