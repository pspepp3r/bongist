    ...
    <div class="container-fluid">
        <div class="row my-lg-3">
            ...
            <div class="col-lg-6 pr-lg-0 order-lg-1">
                <div class="dark-overlay mh-full-screen-with-header h-100"><img src="https://d19m59y37dris4.cloudfront.net/sell/1-2-5/img/photo/photo-1534126511673-b6899657816a.0a721385.jpg" alt="" class="bg-image"></div>
            </div>
        </div>
    </div>
</section>