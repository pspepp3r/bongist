                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($orders as $order) {
                            ...
                            ?>
                            <tr>
                                <td><a href="admin/orders/<?php echo $order_id; ?>/details" class="btn btn-secondary"
                                        style="text-transform: uppercase;"><?php echo $order_id; ?></a></td>
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li>
                                                    <a class="d-flex align-items-center link-muted py-2 px-3"
                                                        data-toggle="modal" href="#editOrderModal"
                                                        onclick="$('.order_id').val('<?php echo $order_id; ?>'); $('.order_status').val('<?php echo $status; ?>');"><i
                                                            class="fa fa-plus mr-2"></i>Edit</a>
                                                </li>
                                                <li>
                                                    <a class="d-flex align-items-center link-muted py-2 px-3"
                                                        data-toggle="modal" href="#deleteOrderModal"
                                                        onclick="$('.id').val('<?php echo $id; ?>');"><i
