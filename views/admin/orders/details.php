            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <header class="card-header d-flex align-items-center">
                        <h2 class="h3 card-header-title">Order ID : <span
                                class="text-dark text-uppercase"><?= $order_id; ?></span></h2>
                        ...
                        <ul class="list-inline ml-auto mb-0">
                            ...
                            if ($role == 1) {
                                ...
                                <li class="list-inline-item mr-3">
                                    <a class="link-muted h3 text-info" data-toggle="modal" href="#editOrderModal"
                                        onclick="$('.order_id').val('<?= $order_id; ?>'); $('.order_status').val('<?= $status; ?>'); $('.customer_id').val('<?= $customer_id; ?>');"><i
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="align-items-center">
                                        ...
                                        ?></p>
                                        <span>Type: <p class="badge badge-soft-info"><?= $type ?></p> Category: <p
                                                class="badge badge-soft-secondary"><?= $category; ?></p></span>
                                        <div>
                                            ...
                                            if ($payments > 0) {
                                                foreach ($payments as $payment) {
                                                    ...
                                                    $type = $payment['type'];
                                                    ?>
                                                    <p class="mb-0">Amount : <?= '₦' . number_format($amount); ?> <span
                                                            class="badge badge-soft-success"><?= $type; ?> </span></p>
                                                    <?php
                                                }
                                            } else {
                    ...
                    <footer class="card-footer d-flex align-items-center">
                        <div class="ml-auto">
                            <a class="btn btn-dark" data-toggle="modal" href="#addPaymentModal"
                                onclick="$('.order_id').val('<?= $order_id; ?>'); $('.customer_id').val('<?= $customer_id; ?>'); $('.order_cost').val('<?= $balance; ?>');">Add
                                Payment</a>
                            <a class="btn btn-dark" data-toggle="modal" href="#addNoteModal"
                                onclick="$('.order_id').val('<?= $order_id; ?>');">Add note</a>
                        </div>
                    </footer>
                </div>
            </div>
