...
<div class="u-body">
    <div class="card mb-4">
        <header class="card-header">
            <h2 class="h3 card-header-title text-uppercase"><?= $slug; ?> Orders</h2>
        </header>
                ...
                <table class="table table-hover">
                    ...
                    if ($orders) {
                      ...
                      foreach($orders as $order)
                      {
                        ...
                        ?>
                        <tr>
                          <td><a href="admin/orders/<?= $order_id; ?>/details" class="btn btn-secondary" style="text-transform: uppercase;"><?= $order_id; ?></a></td>
                          <td><?= $customer; ?></td>
                            ...
                            <td class="text-center">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown" style="width: 150px;" aria-labelledby="actions1Invoker">
                                <ul class="list-unstyled mb-0">
                                  <li>
                                    <a class="d-flex align-items-center link-muted py-2 px-3" data-toggle="modal" href="#editOrderModal" onclick="$('.order_id').val('<?= $order_id; ?>'); $('.order_status').val('<?= $status; ?>');"><i class="fa fa-plus mr-2"></i>Edit</a>
                                  </li>
                                  <li>
                      ...
                      respond::alert('info',  '', 'No '.$type.' under '.$status);
                    }
                    ?>
                    </tbody>
                </table>
