			...
			<div class="col-md-12">
				<?php
												...
												<div class="alert alert-success" >
												  <strong>Blog has been successfully added</strong><br>
												  </div>
													<?php
														 ...
														 ?>
												<div class="alert alert-danger" >
												  <strong>Sorry, there was an error adding blog</strong><br>
												  </div>
													<?php
													}
												}
								...
								<div class="col-md-12 col-sm-12 article-block">
									...
									<div class="row it<?php echo $blog['id'];?>">
										<div class="col-md-3 blog-img blog-tag-data">
											<img src="../img/blog/<?php echo $blog['thumbnail'];?>" alt="" class="img-responsive">
											...
											<div class="form-group">
												...
												<div class="form-group">
													<label class="control-label">Description</label>
														<textarea required name="blog" id="text" class="form-control summernote" rows="6"></textarea>
												</div>
