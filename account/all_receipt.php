...
<div class="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md">
    <h1 class="text-2xl font-semibold mb-6 text-center">Receipts</h1>
    ...
    <table class="min-w-full border border-gray-200">
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" class="py-2 px-4 text-center border-b">No receipts found.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
function openModal(receiptId) {
    ...
    document.getElementById('confirmDeleteBtn').href = '?delete_id=' + receiptId;
}
